...
<body>
    ...
    <main>
        ...
        <aside>
            ...
            <p>HTML5 es la quinta y última versión del Lenguaje de Marcado de Hipertexto (HTML), e introduce elementos semánticos como header, nav, main, section, article, aside y footer para organizar el contenido de forma más clara.</p>
        </aside>
